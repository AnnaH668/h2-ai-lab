...
export const H2Logo = ({ className }: { className?: string }) => (
  <img 
    ...
    style={{ display: 'block' }}
    onError={(e) => {
      // In case the logo.png is not yet available in the environment, show a simple styled text
      const target = e.target as HTMLImageElement;
      target.style.display = 'none';
      const fallback = document.createElement('div');
      fallback.className = 'font-bold text-xl text-brand-primary tracking-tighter';
      fallback.innerText = 'H2 AI LAB';
...
export const Brain = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .52 8.105 3.001 3.001 0 0 0 5.562 1.411 1 1 0 0 1 1.482 0 3 3 0 0 0 5.562-1.411 4 4 0 0 0 .52-8.105 4 4 0 0 0-2.526-5.77A3 3 0 0 0 12 5Z"/><path d="M9 13a4.5 4.5 0 0 0 3-4"/><path d="M15 13a4.5 4.5 0 0 1-3-4"/><path d="M12 13V8"/></svg>
);
